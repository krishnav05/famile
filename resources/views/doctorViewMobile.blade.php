...
<body>
    ...
    <div class="tabs">
        ...
        <span>{{$profile['name']}}</span>
            @endif
          @endforeach
        <a href="Dashboard.html"> <button style="border-color:#FF4176;border:1px solid #FF4176;color: #FF4176;margin-left: 7%;">Quick
            View</button></a>
       <a href="Prescription-pictures.html"> <button>Prescription</button></a>
    ...
    <a href="Prescription-History.html"><button id="visit"><span style="padding:2px 8px 2px 8px; background-color:#ffffff;color: #33CAFF;margin-right: 10px;border-radius: 10px;">3</span>Visits
