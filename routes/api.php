    ...
    'error' => 'error'
    	...
    	if($check)
    	{
            ...
            curl_setopt_array($curl, array(
              CURLOPT_URL => "https://2factor.in/API/V1/7f3c1f82-0d1b-11eb-9fa5-0200cd936042/SMS/".$_POST['phone']."/".$otp."/AUTOVERIFY2",
...
File::makeDirectory($path, $mode = 0777, true, true);
    ...
    Route::post('getprofilechartdata',function(Request $request){
     $data = ConvertedPrescription::where('profile_id',$request->profile_id)->select(DB::raw("(COUNT(*)) as count"),DB::raw("MONTHNAME(consultation_date) as monthname"))->whereYear('consultation_date', '20')
->groupBy('monthname')
->get();
