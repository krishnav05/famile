<?php
    ...
    //custom routes
    Route::get('/users','\App\Http\Controllers\Admin\ProfileController@getUsers')->middleware('auth:admin');
    Route::get('/user/{id}','\App\Http\Controllers\Admin\ProfileController@getUserProfiles')->middleware('auth:admin');
    Route::get('/doc/{id}','\App\Http\Controllers\Admin\ProfileController@getDocList')->middleware('auth:admin');
