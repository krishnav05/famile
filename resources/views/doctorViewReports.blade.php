...
<head>
    ...
    <link rel="stylesheet" href="/bootstrap-4.3.1-dist/bootstrap-4.3.1-dist/js/bootstrap.bundle.min.js">
...
<body style="width: 100%;margin: 0px;">
    ...
    <section class="head">
        <span
            style="align-items: center;color: #ffffff;font-weight: 500;font-size: 1.2rem;">Dashboard</span>
    </section>
    ...
    <div class="tabs">
      ...
      <a href="./reports"> <button style="border-color:#FF4176;border:1px solid #FF4176;color: #FF4176">Reports</button></a>
    </div>
                ...
                <div class="shadow-sm p-3 mb-5 bg-white rounded">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-9">
                                <p class="card-text" style="color:#FF4176;float: left;">Blood Group</p>
                ...
                <div class="shadow-sm p-3 mb-5 bg-white rounded">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-9">
                                <p class="card-text" style="color:#FF4176;float: left;">Blood Pressure</p>
                ...
                <div class="shadow-sm p-3 mb-5 bg-white rounded">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-9">
                                <p class="card-text" style="color:#FF4176;float: left;">Blood Glucose</p>
                ...
                <div class="shadow-sm p-3 mb-5 bg-white rounded">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-9">
                                <p class="card-text" style="color:#FF4176;float: left;">Hemoglobin</p>
                ...
                <div class="shadow-sm p-3 mb-5 bg-white rounded">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-9">
                                <p class="card-text" style="color:#FF4176;float: left;">Pulse Rate</p>
                ...
                <div class="shadow-sm p-3 mb-5 bg-white rounded">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-9">
                                <p class="card-text" style="color:#FF4176;float: left;">Temperature</p>
        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active ">
                <embed src="/assets/Health-report.pdf" type="application/pdf" style="width: 375px;height: 667px;"></embed>
              </div>
              <div class="carousel-item">
                <embed src="/assets/Health-report.pdf" type="application/pdf" style="width: 375px;height: 667px;"></embed>
              </div>
              <div class="carousel-item">
                <embed src="/assets/Health-report.pdf" type="application/pdf" style="width: 375px;height: 667px;"></embed>           </div>
            </div>
