...
<body style="width: 100%;margin: 0px;">
    ...
    <div class="tabs">
        <img id="avt" src="assets/img_avatar.png" alt="Avatar"><span>Satish</span>
      <a href="Dashboard.html">  <button style="margin-left: 7%;">Quick View</button></a>
      <a href="Prescription-pictures.html"> <button style="border-color:#FF4176;border:1px solid #FF4176;color: #FF4176">Prescription</button></a>
    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          ...
          <div class="carousel-item ">
            <img class="d-block w-100" src="assets/prescription-2.png" alt="First slide">
          </div>
          @endif
            @endforeach
          <div class="carousel-item">
